...
module.exports = {
	...
	run: async (guild) => {
        ...
        setup_generell.set(guild.id);

		const channel = guild.channels.cache.find(channel => channel.type === 'text' && channel.permissionsFor(guild.me).has('SEND_MESSAGES'))
		const cmdHelpEmbed = new Discord.MessageEmbed()
		.setAuthor('AI-Chan (' + VERSION + ') - Information', 'https://media.discordapp.net/attachments/698166123874615326/873351999419203614/246880.png?width=895&height=671')
